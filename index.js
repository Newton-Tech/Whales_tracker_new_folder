...
const USDT_Contract_ADD = "0xdAC17F958D2ee523a2206206994597C13D831ec7";
...
const contract = new Contract(USDT_Contract_ADD, ERC20_ABI, provider);

const TRANSFER_THRESHOLD = 100000 * 10 ** 6; // 100,000 USDT wei

const playSound = () => {
  const sound = new player("/ding.mp3");
  sound.play();
};
